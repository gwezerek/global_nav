...
var commonJavascriptLibs = ['d3', 'jquery'];

gulp.task('js-common', fiveThirtyEightGulpTasks.javascript.compileCommon({ include: commonJavascriptLibs }));

gulp.task('js-dev', fiveThirtyEightGulpTasks.javascript.compile({ exclude: commonJavascriptLibs }));
gulp.task('js-full', ['js-common'], fiveThirtyEightGulpTasks.javascript.compile({ exclude: commonJavascriptLibs }));
...
var extraTemplateVars = {
  ...
  notes: require("./src/data/notes.json")
};
